package co.com.alpha.bcb.api;

import co.com.alpha.bcb.model.post.generic.DomainEvent;
import co.com.alpha.bcb.usecase.addcomment.AddCommentUseCase;
import co.com.alpha.bcb.usecase.createpost.CreatePostUseCase;
        ...
        return route(
                ...
                request -> ServerResponse.ok().contentType(MediaType.APPLICATION_JSON)
                        .body(BodyInserters.fromPublisher(useCase
                                .apply(request.bodyToMono(CreatePostCommand.class)),
                                DomainEvent.class))
        );
    }
